...
export default function QuestionReferenceImages({ name, endpoint, linkKey, session }: { name: string; endpoint: string; linkKey: string; session: string }) {
  ...
  }, [name, endpoint, linkKey, session, refresh]);
